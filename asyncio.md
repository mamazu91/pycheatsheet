...
1. **Корутины против процессов:** поскольку 1 процесс = 1 CPU, несколько процессов это хороший способ использовать больше CPU, однако ими сложнее управлять;
2. **Треды:** кол-во тредов, которое можно запустить на CPU, ограничено в отличие от кол-ва корутин. Так же треды потребляют гораздо больше памяти;
